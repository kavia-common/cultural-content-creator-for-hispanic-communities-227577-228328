...
test('CaptionsPanel allows editing and saving a caption', async () => {
  ...
  render(
    <CaptionsPanel
      ...
      status="success"
      captions={[
        { id: '1', text: 'Long text', variationType: 'long', language: 'en', emotion: 'security' },
        { id: '2', text: 'Short text', variationType: 'short', language: 'en', emotion: 'security' },
        { id: '3', text: 'Question text?', variationType: 'question', language: 'en', emotion: 'security' }
      ]}
